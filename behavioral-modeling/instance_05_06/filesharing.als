/*  
File system model for the generation of instances 5 and 6 of the "Behavioral
modeling" chapter, "Validating the design" section, of the Practical Alloy book.
...
run behavioral_modeling_instance_05_06 {
  some f0 : File, disj t0, t1 : Token {
    File  = f0
    Token = t0 + t1
    stutter;upload[f0];always stutter
  }
} expect 1
