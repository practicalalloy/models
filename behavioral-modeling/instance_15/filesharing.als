/*  
File system model for the generation of instance 15 of the "Behavioral modeling"
...
run behavioral_modeling_instance_15 {
  some f0 : File, disj t0, t1 : Token {
    File  = f0
    Token = t0 + t1
    upload[f0];share[f0, t1];share[f0, t0];download[t1];delete[f0];empty;always stutter
  }
} expect 1
