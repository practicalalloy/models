/*   
File sharing app model for the generation of instances 5 and 6 of the "An idiom
for event depiction" topic, "Depicting parameterless events" section, of the
...
run event_depiction_instance_05_06 {
