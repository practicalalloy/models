/*   
File sharing app model for the generation of instance 9 of the "An idiom for
event depiction" topic, "Depicting events with parameters" section, of the
...
run event_depiction_instance_09 {
