/*   
File sharing app model for the generation of instance 1 of the "Inductive
invariants" topic, "Non-inductive invariants" section, of the Practical Alloy
book.
...
check inductive_invariants_instance_01 {
