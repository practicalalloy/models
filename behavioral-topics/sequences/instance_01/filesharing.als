/*   
File sharing app model for the generation of instance 1 of the "Sequences"
topic, "Replacing sets with sequences" section, of the Practical Alloy book.
...
run sequences_instance_01 {
  eventually some disj f1, f2 : File | f1 + f2 in elems[Trash.trashed]
  some disj f0, f1 : File {
    File = f0 + f1
    no Token
    after uploaded = f0
