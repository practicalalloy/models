/*   
File sharing app model for the generation of instance 1 of the "A temporal logic
primer" topic, "Everything is a trace" section, of the Practical Alloy book.

https://practicalalloy.github.io/chapters/behavioral-topics/topics/temporal-logic/index.html#everything-is-a-trace
*/
...
run temporal_logic_instance_01_02 {
  some disj f0, f1 : File, disj t0, t1 : Token {
    File  = f0 + f1
    Token = t0 + t1
    upload[f1]; upload[f0]; share[f1, t0]; share[f0, t1]; delete[f0]; download[t0]; empty; always stutter
  }
} expect 1
