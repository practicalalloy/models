/*  
Leader election model for the generation of instance 13 of the "Protocol design"
chapter, "Making the specification more abstract" section, of the Practical
Alloy book.
...
run protocol_design_instance_13 {
  eventually some Elected
