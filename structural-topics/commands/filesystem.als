...
assert no_partitions {
    ...
    no_indirect_containment implies all o : Object | reachable[o]
}
...
check check_no_partitions {
    no_indirect_containment implies Object - Root = Root.^(entries.object)
} for 6
...
fun some_contents [d:Dir]: some Object {
  d.entries.object
}
